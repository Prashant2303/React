...
import { Jumbotron, Navbar, Nav, NavbarToggler, NavItem, NavbarBrand, Collapse, Button, Modal, ModalBody, ModalHeader, FormGroup, Form, Label, Input } from 'reactstrap';
                ...
                <Modal isOpen={this.state.isModalOpen} toggle={this.toggleModal}>
                    ...
                    <ModalBody>
                        <Form onSubmit={this.handleLogin}>
                            ...
                            <Button type='submit' value='sumit' color='primary'>Login</Button>
                        </Form>
                    </ModalBody>
                </Modal>
            </>
